...
templates = ["/mdh_matmul_m16_opentuner.json_template", 
            "/mdh_matmul_m16_opentuner_biased.json_template",
            "/mdh_matmul_m16_embedding_random_sampling.json_template",
            "/mdh_matmul_m16_embedding_random_sampling_biased.json_template"]
json_files= ["/mdh_matmul_m16_opentuner.json",
            "/mdh_matmul_m16_opentuner_biased.json",
            "/mdh_matmul_m16_embedding_random_sampling.json",
            "/mdh_matmul_m16_embedding_random_sampling_biased.json"]
