...
templates = ["/mdh_conv_n16_opentuner.json_template", 
            "/mdh_conv_n16_opentuner_biased.json_template",
            "/mdh_conv_n16_embedding_random_sampling.json_template",
            "/mdh_conv_n16_embedding_random_sampling_biased.json_template"]
json_files= ["/mdh_conv_n16_opentuner.json",
            "/mdh_conv_n16_opentuner_biased.json",
            "/mdh_conv_n16_embedding_random_sampling.json",
            "/mdh_conv_n16_embedding_random_sampling_biased.json"]
