...
#SBATCH --job-name=evaluation_mdh_matmul_m16    # the name of your job
...
cd ~/evaluation/
cp -rf baco_paper_version ./mdh_matmul_m16/baco_$SLURM_ARRAY_TASK_ID
cd mdh_matmul_m16/baco_$SLURM_ARRAY_TASK_ID
python3 mdh_matmul_run_m16.py $SLURM_ARRAY_TASK_ID
