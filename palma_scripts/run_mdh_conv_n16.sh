...
#SBATCH --job-name=evaluation_mdh_conv_n16      # the name of your job
...
cd ~/evaluation/
cp -rf baco_paper_version ./mdh_conv_n16/baco_$SLURM_ARRAY_TASK_ID
cd mdh_conv_n16/baco_$SLURM_ARRAY_TASK_ID
python3 mdh_conv_run_n16.py $SLURM_ARRAY_TASK_ID
